...
%\author[label2]{Guillermo Dur�n}
%\author[label3]{Pablo Rey}
%\author[label4]{Tom�s Reyes}
%\author[label5]{Antoine Saur�}
%\author[label6]{Denis Saur�}
%\author[label7]{Gustavo Angulo}

%\address[label1]{School of Engineering, Pontificia Universidad Cat�lica de Chile, Av. Vicu�a Mackenna 4860, Santiago, Chile. Corresponding Author. Tel: +56 (2) 2354 1234. Email: aecatald@uc.cl}
%\address[label2]{XXX, Universidad de Buenos Aires, XXX, Buenos Aires, Argentina.}
%\address[label3]{XXX, Universidad Tecnol�gica Metropolitana, XXX, Santiago, Chile.}
%\address[label4]{School of Engineering, Pontificia Universidad Cat�lica de Chile, Av. Vicu�a Mackenna 4860, Santiago, Chile.}
%\address[label5]{Telfer School of Management, Universidad de Ottawa, 55 Laurier Ave E, Ottawa, Canad�.}
%\address[label6]{School of Engineering, Universidad de Chile, XXX, Santiago, Chile.}
%\address[label7]{School of Engineering, Pontificia Universidad Cat�lica de Chile, Av. Vicu�a Mackenna 4860, Santiago, Chile.}
\end{frontmatter}

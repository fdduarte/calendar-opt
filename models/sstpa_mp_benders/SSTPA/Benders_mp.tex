...
\end{equation}
\begin{equation}\label{ecua11a}
   M(1-\alpha_{ji}^l) \geq p_{ji}^{lF} - p_{ii}^{lF} \qquad \forall l \in \mathcal{F}; i,j \in \mathcal{I}: i \neq j.
\end{equation}
...
\begin{multline}\label{ecua10}
  ...
  + \sum\limits_{n \in \mathcal{N}: EV_{jn}=1}\sum\limits_{l \in \mathcal{F}: f \geq \theta > l}3\hat{a}_{ni}^{l\theta} + \sum\limits_{n \in \mathcal{N}: EL_{jn}+ EV_{jn}=1}\sum\limits_{l \in \mathcal{F}: f \geq \theta > l}\hat{e}_{ni}^{l\theta} \qquad \forall i,j \in \mathcal{I}; f,l \in \mathcal{F}: f > l.
\end{multline}
\begin{equation}\label{ecua12}
   M\hat{\alpha}_{ji}^l \geq \hat{p}_{ii}^{lF} - \hat{p}_{ji}^{lF} \qquad l \in \mathcal{F}; \forall i,j \in \mathcal{I}: i \neq j.
\end{equation}
